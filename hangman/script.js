...
function dead() {
  ...
  errorMessagesEl.innerText = "You have tried too many times. The correct word was '" + word + 
    "'. Click to try again";
  document.addEventListener("click", function(){location.reload()}); //Reload in new function to
    //prevent firing upon creation
}
...
function win() {
  ...
  document.addEventListener("click", function(){location.reload}) //In new function to prevent
    //firing upon creation
}
